...
Write this as a complete, ready-to-use lesson plan with AUTHORITATIVE, DIRECTIVE language. Use imperative voice and clear instructions that tell teachers exactly what to do and what students will do. Avoid suggestive language like "you could" or "try this" - instead use direct commands and statements.
...
**Teacher Instructions:** Present two options to students. Students choose one option or say "None, I..." and complete with their own answer.
...
**Teacher Instructions:** Distribute activity cards with {theme} topics and adjective cards. Students match activities with opinion adjectives.
...
**Teacher Instructions:** Show incomplete sentences with emoji clues. Students complete the sentences using target vocabulary.
...
**Grammar Point:** like/love/hate/enjoy + verb + -ing + connectors
**Teacher Instructions:** Introduce the grammar pattern, then drill with {theme} examples.
...
### Speaking Challenge
**Teacher Instructions:** Give students these prompts and have them speak for 2-3 minutes each.
**Prompts:**
...
**Teacher Instructions:** Assign roles and give students 5 minutes to prepare, then perform for the class.
**Required elements:**
...
**Teacher Instructions:** Teach these expressions, then have students apply them to {theme} activities.
**Time:** 10 minutes

## Mini Wrap-Up and Assessment (10-15 minutes)
**Teacher Instructions:** Ask these review questions to check understanding.
**Review questions:**
1. Which verbs do we use followed by -ing when talking about likes and dislikes?
2. How do you describe {theme} activities using opinion adjectives?
3. Tell me something about {theme} that your family member likes/doesn't like
...
Write everything in clear, directive language that tells teachers exactly what to do step-by-step.
"""
